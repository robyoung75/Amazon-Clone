    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            id="49538094"
            title="Kenwood kMix Stand Mixer for4 Baking, Stylish Kitchen Mixer with K-beater, Dough Hook and Whisk, 5 Litre Glass Bowl"
            price={239.0}
        ...
        <div className="home__row">
          <Product
            ...
            price={1094.98}
            rating={4}
            image="https://images-na.ssl-images-amazon.com/images/I/6125mFrzr6L._AC_SX385.jpg"
          />
        </div>
      </div>
    </div>
